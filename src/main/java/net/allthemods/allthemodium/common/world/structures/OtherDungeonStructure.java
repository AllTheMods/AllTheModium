...
public class OtherDungeonStructure extends ATMJigsawStructure {
    
    public static final MapCodec<OtherDungeonStructure> CODEC = ATMJigsawStructure.codec(OtherDungeonStructure::new);
    
    public OtherDungeonStructure(
    ...
    public StructureType<?> type() {
        return ATMStructureTypes.OTHER_DUNGEON.get();
    }
}
