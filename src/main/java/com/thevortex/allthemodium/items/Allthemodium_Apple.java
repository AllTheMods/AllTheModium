...
public class Allthemodium_Apple extends Item {
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
		...
		if((entityLiving instanceof PlayerEntity) && (stack.getItem() == ModItems.ALLTHEMODIUM_APPLE)) {
			...
			player.addPotionEffect(new EffectInstance(Effects.REGENERATION,600,9,false,false));
			player.addPotionEffect(new EffectInstance(Effects.ABSORPTION,600,9,false,false));
		}
