...
public class OtherPortalFrameBlock extends Block {
        ...
        public OtherPortalFrameBlock(AbstractBlock.Properties properties) {
            super(properties);
