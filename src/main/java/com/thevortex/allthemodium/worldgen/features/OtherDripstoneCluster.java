...
public class OtherDripstoneCluster extends Feature<DripstoneClusterConfiguration> {
        ...
        private boolean canBeAdjacentToWater(LevelAccessor p_159583_, BlockPos p_159584_) {
            ...
            return blockstate.is(TagRegistry.ANCIENT_STONE) || blockstate.getFluidState().is(FluidTags.WATER);
        }
