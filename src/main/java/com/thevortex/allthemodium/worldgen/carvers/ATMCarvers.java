...
public class ATMCarvers {
    public static final Lazy<ConfiguredWorldCarver<CaveCarverConfiguration>> NETHER_CAVE_CWC = configure("other_cave", ModRegistry.OTHER_CARVER, new CaveCarverConfiguration(0.1F, UniformHeight.of(VerticalAnchor.aboveBottom(64), VerticalAnchor.belowTop(280)), ConstantFloat.of(0.5F), VerticalAnchor.aboveBottom(1), false, ConstantFloat.of(1.0F), ConstantFloat.of(1.0F), ConstantFloat.of(-0.7F)));
