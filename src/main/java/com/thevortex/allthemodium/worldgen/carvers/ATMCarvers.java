...
public class ATMCarvers {
    public static final Lazy<ConfiguredWorldCarver<CaveCarverConfiguration>> NETHER_CAVE_CWC = configure("nether_cave", ModRegistry.OTHER_CARVER, new CaveCarverConfiguration(0.1F, UniformHeight.of(VerticalAnchor.aboveBottom(64), VerticalAnchor.belowTop(280)), ConstantFloat.of(0.5F), VerticalAnchor.aboveBottom(1), false, ConstantFloat.of(1.0F), ConstantFloat.of(1.0F), ConstantFloat.of(-0.7F)));
    public static final Lazy<ConfiguredWorldCarver<CaveCarverConfiguration>> OTHER_CAVE_CWC = configure("nether_caverns", ModRegistry.OTHER_CAVE_CARVER, new CaveCarverConfiguration(0.12F, UniformHeight.of(VerticalAnchor.aboveBottom(1), VerticalAnchor.belowTop(250)), ConstantFloat.of(0.5F), VerticalAnchor.aboveBottom(1), false, ConstantFloat.of(1.0F), ConstantFloat.of(1.0F), ConstantFloat.of(-0.7F)));
