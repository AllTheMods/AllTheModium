...
public class BlockRegistry {
    ...
    public static final RegistryObject<LiquidBlock> SOULLAVA_BLOCK = BLOCKS.register("soul_lava",() -> new SoulLava(FluidRegistry.SOULLAVA, Block.Properties.of(Material.LAVA).noCollission().strength(100f).noOcclusion().jumpFactor(0.1F).speedFactor(0.01F).lightLevel((light) -> {
            return 15;
    }).color(MaterialColor.COLOR_BLUE).noLootTable()));
