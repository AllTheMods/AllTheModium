...
public class MoltenVIBType extends FluidType {
    ...
    public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
        consumer.accept(new IClientFluidTypeExtensions() {
            ...
            private static final ResourceLocation FLUID_STILL = new ResourceLocation(Reference.MOD_ID, "block/fluid/vibranium_molten_still");
            private static final ResourceLocation FLUID_FLOW = new ResourceLocation(Reference.MOD_ID, "block/fluid/vibranium_molten_flow");
            private static final ResourceLocation FLUID_OVERLAY = new ResourceLocation(Reference.MOD_ID, "block/fluid/vibranium_molten_still");
